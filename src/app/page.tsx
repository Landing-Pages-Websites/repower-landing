          ...
          <div className="mb-4">
            ...
            <div className="flex gap-3">
              <label className="flex-1 cursor-pointer">
                <input type="radio" name="budget" value="yes" required className="sr-only peer" onChange={() => setFormData({ ...formData, budget: "yes" })} />
                <div className="peer-checked:bg-accent peer-checked:border-accent peer-checked:text-white border-2 border-white/20 text-gray-300 rounded-lg py-2.5 text-center font-display font-semibold uppercase tracking-wider transition-all">
                  Yes
                </div>
              </label>
              <label className="flex-1 cursor-pointer">
                <input type="radio" name="budget" value="no" className="sr-only peer" onChange={() => setFormData({ ...formData, budget: "no" })} />
                <div className="peer-checked:bg-accent peer-checked:border-accent peer-checked:text-white border-2 border-white/20 text-gray-300 rounded-lg py-2.5 text-center font-display font-semibold uppercase tracking-wider transition-all">
                  No
                </div>
              </label>
  ...
  return (
    <>
      ...
      <div className={`fixed bottom-0 left-0 right-0 md:bottom-6 md:right-6 md:left-auto z-40 transition-all duration-500 ${showFloating ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8 pointer-events-none"}`}>
        <div className="bg-primary/95 backdrop-blur-md md:rounded-2xl shadow-2xl p-4 flex items-center justify-center gap-3 border-t border-white/10 md:border md:border-white/10">
          <a href="#contact" className="bg-accent text-white px-6 py-3 font-display font-bold uppercase tracking-wider text-sm hover:bg-accent/90 transition-all rounded-lg">
            Book Now
          </a>
          <a href={PHONE_HREF} className="border-2 border-white text-white px-5 py-2.5 font-display font-semibold uppercase tracking-wider text-sm hover:bg-white hover:text-primary transition-all rounded-lg flex items-center gap-2">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
            {PHONE}
          </a>
        </div>
